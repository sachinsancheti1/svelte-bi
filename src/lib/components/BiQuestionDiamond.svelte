...
<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" class:bi={true} class:bi-question-diamond={true} class={klass} viewBox="0 0 16 16" {...rest}>
